...
<html lang="en">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Welcome Admin <%out.println(name);%></h3>
								<ul class="breadcrumb">
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
								<% List<user> list1=admindao.getTotalList(); 
									request.setAttribute("total",list1); %>
									...
									<div class="dash-widget-info">
										...
										<a href="totalemployee.jsp">Employees </a>
							...
							<div class="card-group m-b-30">
								<div class="card">
									<div class="card-body">
										...
										<p class="mb-0"><a href="totalemployee.jsp">Overall Employees 5</a></p>
									</div>
								</div>
    ...
    <div class="col-md-6 d-flex">
        <div class="card card-table flex-fill">
            <div class="card-header">
                <h3 class="card-title mb-0">Employee Approve</h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
...
<select id="entries" onchange="changeEntries()">
  ...
  <option value="all">All</option>
                    ...
                    <% List<user> list=empdao.getApprovalList(); 
                        ...
                        <thead>
                         ...
                         <tbody>
                                    <c:forEach items="${approval}" var="u">
                            <tr>
                                <td> ${u.getEmp_id()}</td>
                                <td>
                                ...
                                <td>
                                    <div class="dropdown action-label">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="approve_emp.jsp?id=${u.getEmp_id()}"><i class="fa fa-dot-circle-o text-success"></i> Approve</a>
                                            <a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> UnApprove</a>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-right">
...
<select id="entries" onchange="changeEntries()">
  ...
  <option value="all">All</option>
                    ...
                    <table class="table custom-table mb-0" id="data-table">
                    <% List<leaveuser> listl=emp_leave_dao.LeaveDataViewlist(); 
						request.setAttribute("approval",listl); %>
                        <thead>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="leaveview.jsp?id=${u.getLeave_id()}"><i class="fa fa-pencil m-r-5"></i> View</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
