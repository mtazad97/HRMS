            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul>
							<li> 
								<a href="dashboard.jsp"><i class="la la-home"></i> <span>Back to Home</span></a>
							</li>
							<li class="menu-title">Settings</li>
							<li class="active"> 
								<a href=""><i class="la la-building"></i> <span>Company Settings</span></a>
							</li>
							<li> 
								<a href="ad_profile.jsp"><i class="la la-clock-o"></i> <span>Profile</span></a>
							</li>
							<li> 
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input class="form-control" type="text" value="Afroz Softonic">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label>Contact Person</label>
											<input class="form-control " value="Tausif Azad" type="text">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											<label>Address</label>
											<input class="form-control " value="IT Park,Ambazari" type="text">
										</div>
									</div>
									...
									<div class="col-sm-6 col-md-6 col-lg-3">
										<div class="form-group">
											<label>City</label>
											<input class="form-control" value="Nagpur" type="text">
										</div>
									</div>
									<div class="col-sm-6 col-md-6 col-lg-3">
										<div class="form-group">
									...
									<div class="col-sm-6 col-md-6 col-lg-3">
										<div class="form-group">
											...
											<input class="form-control" value="440008" type="text">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Email</label>
											<input class="form-control" value="tausifazad09@gmail.com" type="email">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
